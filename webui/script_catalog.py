    ...
    SCRIPTS = {
        "generate_dataset": {
            ...
            "sections"   : [
                ...
                {"title": "Sampler",  "fields": ["env.mean_jobs", "env.std_jobs", "env.min_jobs", "env.mean_vehicles", "env.std_vehicles", "env.min_vehicles", "env.radius", "env.center", "env.outlier_frequency", "env.outlier_multiplier", "env.reset_max_attempts"]},
        ...
        "pretrain": {
            ...
            "sections"   : [
                ...
                {"title": "Reward",      "fields": ["reward.distance_weight", "reward.unassigned_penalty_weight", "reward.idle_penalty_weight", "reward.priority_penalty_weight", "reward.add_job_cost", "reward.remove_job_cost", "reward.no_action_cost", "reward.reoptimize_cost", "reward.disruption_cost"]},
        ...
        "evaluate": {
            "title"      : "Evaluate",
            "group"      : "Evaluation",
            "summary"    : "Compare the checkpoint against teacher, insertion-only, always-reoptimize, and do-nothing baselines.",
            ...
            "sections"   : [
                ...
                {"title": "Evaluation", "fields": ["evaluation.episodes", "evaluation.seed", "training.max_steps_per_episode", "env.step_event_probability"]},
                {"title": "Reward",     "fields": ["reward.distance_weight", "reward.unassigned_penalty_weight", "reward.idle_penalty_weight", "reward.priority_penalty_weight", "reward.add_job_cost", "reward.remove_job_cost", "reward.no_action_cost", "reward.reoptimize_cost", "reward.disruption_cost"]},
                {"title": "Compute",    "fields": ["training.device"]},
                {"title": "Services",   "fields": ["service.vroom_url", "service.osrm_url"]},
            ],
